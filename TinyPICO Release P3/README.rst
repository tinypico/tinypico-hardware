TinyPICO Production Release vP3
===============================

In this repository you'll find Eagle 9.x design files and gerbers for the producton vP3 release of TinyPICO.
...
TinyPICO Branding
-----------------
The name TinyPICO, logos and TinyPICO brand is owned by Unecxpected Maker. If you would liek to use the name in a project you are making that supports the TinyPICO hardware, please conact us and we'll be happy to talk to you about it.
